%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This exercise loads the data from ECOS and FRED using Open API and 
% generates an excel file containing the data.
...
% 3. Saving
% The final table will be saved into "tsdata_date.xlsx" with separate sheet names.
...
end_date = '2025Q2'; % End of the date
start_page = '1';
end_page = '10000';
