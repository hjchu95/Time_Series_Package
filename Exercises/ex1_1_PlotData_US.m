...
save_as_html(f8,save_folder,'figure8',fig_option)
...
save_as_html(f9,save_folder,'figure9',fig_option)
...
f10c = figure('Position',[300 200 1100 600]);
plot_time_series(us_int(:,1:3), ...
    4:20:dus_T, us_xtick_labels2, ...
    [], {'FEDFUNDS','TB3M', 'TB10Y'}, 0)
save_as_html(f10c,save_folder,'figure10c',fig_option)

f10d = figure('Position',[300 200 1100 600]);
plot_time_series(WTI, ...
    4:20:dus_T, us_xtick_labels2, ...
    [], {'WTI'}, 0)
save_as_html(f10d,save_folder,'figure10d',fig_option)
