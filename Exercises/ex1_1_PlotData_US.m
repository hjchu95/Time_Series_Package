...
plot_time_series([log(us_NGDPNSA), log(us_NGDPSA)], ...
    1:20:us_T,us_xtick_labels1, ...
    'US log NGDP Seasonally Adjusted vs Not Seasonally Adjusted', ...
    {'US NGDPNSA','US NGDPSA'},0)
save_as_html(f2,save_folder,'figure1b',fig_option)
